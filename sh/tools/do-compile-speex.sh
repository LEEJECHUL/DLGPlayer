...
FF_BUILD_SOURCE="$FF_BUILD_ROOT/build/src/$FF_BUILD_NAME"
FF_BUILD_PREFIX="$FF_BUILD_ROOT/build/thin/$FF_BUILD_NAME"
...
echo "[*] check OGG"
echo "----------------------"
FFMPEG_DEP_OGG=$FF_BUILD_ROOT/build/thin/$FF_BUILD_NAME_OGG
FFMPEG_DEP_OGG_LIB=$FF_BUILD_ROOT/build/thin/$FF_BUILD_NAME_OGG/lib
#--------------------
# with ogg
