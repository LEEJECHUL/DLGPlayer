...
OTHER_FRAMEWORK_SEARCH_PATHS = "$(PROJECT_DIR)/Libraries"
FRAMEWORK_SEARCH_PATHS = "$(inherited) $(PROJECT_DIR)/Carthage/Build/iOS ${OTHER_FRAMEWORK_SEARCH_PATHS}"
...
projectName = Dir["../*.xcodeproj"]

if projectName.nil?
	abort("Does not exist project to config!")
end

puts "💎💎  Project Found -> #{projectName} 💎💎"

# Variables
@project = Xcodeproj::Project.open(projectName)
